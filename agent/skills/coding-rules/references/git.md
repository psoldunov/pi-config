...
- Ensemblr `Co-authored-by:` trailers are mandatory and **must never be omitted**, even when other agent or tool attribution is prohibited. Preserve the exact trailer supplied by Ensemblr.
